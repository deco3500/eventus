app.controller('CommentsCtrl', function ($scope, $stateParams, ionicMaterialMotion) {
    
   
    console.log($stateParams.id);
    var commentsList=localStorage.getItem($stateParams.id);
    $scope.id=$stateParams.id;
    if(commentsList!==null){
        $scope.comments=JSON.parse(commentsList);
    }
